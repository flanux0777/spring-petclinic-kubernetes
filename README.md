...
My First deployment app as a Devops Junior Engineer
=======
...
#process configurqtion
# Spring PetClinic on Kubernetes

Déploiement complet de l'application Spring PetClinic sur Kubernetes avec MySQL.
...
docker build -t petclinic-spring-app:v1 .


>>>>>>> 8201cc5 (My first Project)
